...
import { LayoutDashboard, Rocket, Edit3, Globe, Menu, X } from 'lucide-react';
...
const AppLayout: React.FC = () => {
  ...
  const navItems = [
    ...
    { path: '/dashboard/investors', label: 'Fundraising', icon: <Rocket className="w-5 h-5" /> },
    { path: '/dashboard/analysis', label: 'Content Optimizer', icon: <Edit3 className="w-5 h-5" /> },
    { path: '/dashboard/competitors', label: 'Market Intel', icon: <Globe className="w-5 h-5" /> },
  ];
